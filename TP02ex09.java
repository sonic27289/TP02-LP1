...
public class TP02ex09{
    ...
    public static void main(String[] args){
        ...
        for(i=0; i <1;)
        {
            System.out.print("Digite a ordem da matriz quadratica (MAX.:10):  "   );
            ordem = Integer.parseInt(sc.nextLine()); 
            if(ordem<=0 || ordem>10)
            {
                System.out.print("Ordem invalida digite um numero valido!!\n"   );
            }
            else
            {
                i++;
        ...
        double coftrans[][] = new double[ordem][ordem]; // Declarando e alocando matriz
        ...
        sc.close();
        if(laplace(mat) == 0.0){
            System.out.println("N�o � poss�vel fazer uma matriz transposta " );
        }
        else
        {
            deter = laplace(mat);
